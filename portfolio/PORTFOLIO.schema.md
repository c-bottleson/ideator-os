...
| `boot_path` | Folder under `projects/` once Prototyped (empty while ideating) |
| `last_move` | One line — what happened last |
| `next_move` | One line — Forge / Prototype / Ass-kick |
...
|---|---|
| Ideating | Forge |
| Building | Prototype’d + Ass-kick toward goal |
